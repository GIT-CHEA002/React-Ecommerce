        ...
        <div>
          ...
          <div className="flex h-screen relative ">
            ...
            <div className="flex-1 relative  z-20 md:ps-12 mt-12 overflow-y-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden scroll-smooth">
              ...
              <div className="sticky top-0 left-0 z-30  w-full bg-white shadow-sm ">
              ...
              <div className="flex snap-mandatory md:grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="h-[380px]  min-w-[250px] snap-start group bg-blue-50 rounded-lg overflow-hidden cursor-pointer shadow-lg shadow-blue-50">
                  {/* image  */}
                  ...
                  <div className=" h-[160px] p-3 flex flex-col justify-between ">
                    <div className="flex justify-between space-x-5">
                      ...
                      <h1 className="font-medium text-wrap line-clamp-2 leading-tight">
                        Tirk Trokoun Teng phirk hx srey denh
                      </h1>
                      <span className="text-blue-900">$299.00</span>
                    </div>
                    <p className=" text-gray-600 font-light line-clamp-2 leading-tight">
                      Escape the noise and lose yourself in pure, high-fidelity
                      sound. Engineered for creators, commuters, and audiophiles
                      alike, the Lumina Pro delivers studio-quality audio
                      directly to your ears, wherever life takes you.
                    </p>
                    <div className="flex justify-between items-center space-x-5 ">
                      <button className="flex-1 text-sm text-blue-900 bg-blue-200 p-2 rounded-lg">
                        View Details
                      </button>
