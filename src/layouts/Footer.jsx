...
export default function Footer() {
  return (
    <footer className="px-6 md:px-8 lg:px-12 pt-6 pb-12 ">
      {/* join sections */}
      <section className="md:px-72 text-gray-600  py-16">
        <h1 className="text-center text-blue-900 text-3xl font-semibold">
          Join Lumina Circle
        </h1>
        <p className="text-center text-base line-clamp-2 py-3">
        ...
        <div className="flex space-x-3">
          <input
            ...
            className="outline-none border-2 flex-1 px-4 py-1 rounded-lg border-gray-500 hover:border-blue-900 text-gray-600"
          />
